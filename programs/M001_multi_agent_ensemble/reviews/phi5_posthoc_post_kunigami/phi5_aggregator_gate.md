...
**Run date:** 2026-07-06T17:34:21.523254+00:00
...
|---|---|---|---|---|---|
| **arm0** (Control (Phi4.1 aggregator)) | 5604 | 0.3618 | +0.0000 | 1.14x | `baseline` |
| **arm1** (HRP (Ledoit-Wolf tangency, TQS covariance)) | 5604 | 0.3549 | +0.0627 | 1.12x | `PASS` |
| **arm2** (TQS-conditional conviction floor (P=0.40, min_n=200)) | 5320 | 0.3643 | +0.0721 | 1.15x | `PASS` |
...
|---|---|---|---|---|
| arm0 | **0.3618** | 0.3632 | 0.3743 | +8.01 |
| arm1 | **0.3549** | 0.3158 | 0.3707 | +8.01 |
| arm2 | **0.3643** | 0.3657 | 0.3741 | +7.91 |
| arm3 | **—** | — | — | — |
| arm4 | **—** | — | — | — |
| arm5 | **—** | — | — | — |
...
- **Verdict:** `PASS`
- **Median window mean TQS:** 0.3643
- **n trades:** 5320
- **n OOS windows with trades:** 7
- _Caveat:_ Dropped 284 trades below per-agent P40 conviction (walk-forward, no lookahead).
- _Caveat:_ 13 trades had no matched proposal (conviction=None) -- retained as free-pass to avoid biasing against the arm.

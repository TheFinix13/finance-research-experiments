# G7 v1 Checkpoint Gate -- Verdict (walk-forward-post-TU)
...
- C5 (fail): stat=0.0860 threshold=0.1000
    - per_window_pass_count: 2
    - per_window_waived_count: 0
    - k_of_n_threshold: 7 of 7
    - mean_statistic_across_computed_windows: 0.0860
...
| `chigiri_hyoma` | 992 | 397 | 0.250 | -0.025 | 0.400 | 0.208 | 0.242 | 0.285 | +0.044 |

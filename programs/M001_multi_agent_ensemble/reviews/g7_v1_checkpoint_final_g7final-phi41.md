# G7 v1 Checkpoint Gate -- FINAL verdict (g7final-phi41)
...
- Leave-one-out caches: `programs/M001_multi_agent_ensemble/reviews/g7_leave_one_out_post-V/lo1_*`
...
|---|---|---|---|---|---|---|---|---|---|
| `isagi_yoichi` | conservative_metavision | `111100` | ✅ 0.356 | ✅ 62.000 | ✅ 7.000 | ✅ 6571.000 | ❌ 0.085 | ❌ 0.083 | no |
| `bachira_meguru` | rebel_tight | `110101` | ✅ 0.385 | ✅ 0.098 | ❌ 0.000 | ✅ 14551.000 | ❌ 0.089 | ✅ 0.154 | no |
| `itoshi_rin` | analytical_precision | `111110` | ✅ 0.375 | ✅ 0.178 | ✅ 7.000 | ✅ 2988.000 | ✅ 0.112 | ❌ 0.086 | no |
...
| `nagi_seishiro` | confluence_only | `101100` | ✅ 0.436 | ❌ 0.000 | ✅ 7.000 | ✅ 658.000 | ❌ 0.000 | ❌ 0.000 | no |
| `barou_shoei` | solo_king | `001101` | ❌ 0.347 | ❌ 0.000 | ✅ 7.000 | ✅ 4576.000 | ❌ 0.068 | ✅ 0.154 | no |
...
- **C5** (fail): stat=0.0855 threshold=0.1000
    - n_trades: 1004
    - mean_lot: 0.1225
    - min_lot: 0.1000
    - max_lot: 0.1400
    - cv: 0.0855
- **C6** (fail): stat=0.0825 threshold=0.1000
    - n_trades: 1004
    - sl_cv: 0.0825
    - tp1_cv: 0.0825
    - mean_sl: 39.0323
...
- **C4** (pass): stat=14551.0000 threshold=1.0000
    ...
    - read_count: 14551
    - note: single-window dry-run; PROTOCOL sec 3 requires both > 0 in >= 7/7 windows for full-panel verdict
- **C5** (fail): stat=0.0888 threshold=0.1000
    - n_trades: 1444
    - mean_lot: 0.0575
    - min_lot: 0.0400
    - max_lot: 0.0600
...
- **C4** (pass): stat=4576.0000 threshold=1.0000
    ...
    - read_count: 4576
    - note: single-window dry-run; PROTOCOL sec 3 requires both > 0 in >= 7/7 windows for full-panel verdict
- **C5** (fail): stat=0.0678 threshold=0.1000
    - n_trades: 62
    - mean_lot: 0.1311
    - min_lot: 0.1100
    - max_lot: 0.1400

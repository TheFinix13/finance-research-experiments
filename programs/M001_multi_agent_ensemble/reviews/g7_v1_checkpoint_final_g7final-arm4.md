# G7 v1 Checkpoint Gate -- FINAL verdict (g7final-arm4)

**Squad verdict: FAIL** (1/7 agents pass all six criteria)

- Aggregator arm: `arm4`
- Baseline cache: `programs/M001_multi_agent_ensemble/reviews/g7_replay_cache_phi5-arm4-post-kunigami`
- Leave-one-out caches: `programs/M001_multi_agent_ensemble/reviews/g7_leave_one_out_phi5-arm4/lo1_*`
...
|---|---|---|---|---|---|---|---|---|---|
| `isagi_yoichi` | conservative_metavision | `101100` | ✅ 0.351 | ❌ 0.000 | ✅ 7.000 | ✅ 6571.000 | ❌ 0.087 | ❌ 0.082 | no |
| `bachira_meguru` | rebel_tight | `110111` | ✅ 0.384 | ✅ 0.136 | ❌ 1.000 | ✅ 14551.000 | ✅ 0.101 | ✅ 0.156 | no |
| `itoshi_rin` | analytical_precision | `111110` | ✅ 0.374 | ✅ 0.132 | ✅ 7.000 | ✅ 2988.000 | ✅ 0.112 | ❌ 0.084 | no |
...
| `nagi_seishiro` | confluence_only | `101100` | ✅ 0.427 | ❌ 0.000 | ✅ 7.000 | ✅ 658.000 | ❌ 0.000 | ❌ 0.000 | no |
| `barou_shoei` | solo_king | `101111` | ✅ 0.388 | ❌ 0.000 | ✅ 7.000 | ✅ 4576.000 | ✅ 0.118 | ✅ 0.183 | no |
...
- **C5** (fail): stat=0.0870 threshold=0.1000
    - n_trades: 1120
    - mean_lot: 0.1220
    - min_lot: 0.1000
    - max_lot: 0.1400
    - cv: 0.0870
- **C6** (fail): stat=0.0823 threshold=0.1000
    - n_trades: 1120
    - sl_cv: 0.0823
    - tp1_cv: 0.0823
    - mean_sl: 38.8651
...
- **C4** (pass): stat=14551.0000 threshold=1.0000
    ...
    - read_count: 14551
    - note: single-window dry-run; PROTOCOL sec 3 requires both > 0 in >= 7/7 windows for full-panel verdict
- **C5** (pass): stat=0.1006 threshold=0.1000
    - n_trades: 2040
    - mean_lot: 0.0588
    - min_lot: 0.0400
    - max_lot: 0.0700
...
- **C5** (pass): stat=0.1119 threshold=0.1000
    ...
    - max_lot: 0.1100
    - cv: 0.1119
- **C6** (fail): stat=0.0841 threshold=0.1000
    - n_trades: 212
    - sl_cv: 0.0841
    - tp1_cv: 0.0841
    - mean_sl: 29.2189
...
- **C4** (pass): stat=4576.0000 threshold=1.0000
    ...
    - read_count: 4576
    - note: single-window dry-run; PROTOCOL sec 3 requires both > 0 in >= 7/7 windows for full-panel verdict
- **C5** (pass): stat=0.1180 threshold=0.1000
    - n_trades: 322
    - mean_lot: 0.1092
    - min_lot: 0.0900
    - max_lot: 0.1400

# G7 v1 Checkpoint Gate -- Verdict (g7retry1-phi41)
...
- C1 (pass): stat=0.3591 threshold=0.3000
    - per_window_pass_count: 7
    - per_window_waived_count: 0
    - k_of_n_threshold: 5 of 7
    - mean_statistic_across_computed_windows: 0.3591
...
- C5 (pass): stat=0.2051 threshold=0.1000
    - per_window_pass_count: 7
    - per_window_waived_count: 0
    - k_of_n_threshold: 7 of 7
    - mean_statistic_across_computed_windows: 0.2051
- C6 (fail): stat=0.1617 threshold=0.1000
    - per_window_pass_count: 6
    - per_window_waived_count: 0
    - k_of_n_threshold: 7 of 7
    - mean_statistic_across_computed_windows: 0.1617

### bachira_meguru (rebel_tight, tier 2)
- C1 (pass): stat=0.3860 threshold=0.3000
    - per_window_pass_count: 7
    - per_window_waived_count: 0
    - k_of_n_threshold: 5 of 7
    - mean_statistic_across_computed_windows: 0.3860
- C2 (pending): stat=0.0000 threshold=0.0000
    - reason: leave-one-out chemistry requires 8 additional replays with each agent removed; deferred to batch run (PROTOCOL sec 8 stop rule #2 wall-clock ~ 32 hours)
- C3 (pending): stat=0.0000 threshold=0.5000
    - reason: non-cannibalising slot behaviour requires per-peer leave-one-out trade-count deltas; shares the batch run with criterion 2
...
- C5 (pass): stat=0.4574 threshold=0.1000
    - per_window_pass_count: 7
    - per_window_waived_count: 0
    - k_of_n_threshold: 7 of 7
    - mean_statistic_across_computed_windows: 0.4574
- C6 (fail): stat=0.1342 threshold=0.1000
    - per_window_pass_count: 6
    - per_window_waived_count: 0
    - k_of_n_threshold: 7 of 7
    - mean_statistic_across_computed_windows: 0.1342
...
- C6 (fail): stat=0.2323 threshold=0.1000
    - per_window_pass_count: 6
    - per_window_waived_count: 0
    - k_of_n_threshold: 7 of 7
    - mean_statistic_across_computed_windows: 0.2323
...
- C5 (pass): stat=0.2458 threshold=0.1000
    - per_window_pass_count: 7
    - per_window_waived_count: 0
    - k_of_n_threshold: 7 of 7
    - mean_statistic_across_computed_windows: 0.2458
- C6 (fail): stat=0.1152 threshold=0.1000
    - per_window_pass_count: 3
    - per_window_waived_count: 0
    - k_of_n_threshold: 7 of 7
    - mean_statistic_across_computed_windows: 0.1152
...
- C5 (fail): stat=0.2516 threshold=0.1000
    - per_window_pass_count: 6
    - per_window_waived_count: 0
    - k_of_n_threshold: 7 of 7
    - mean_statistic_across_computed_windows: 0.2516
- C6 (fail): stat=0.1887 threshold=0.1000
    - per_window_pass_count: 6
    - per_window_waived_count: 0
    - k_of_n_threshold: 7 of 7
    - mean_statistic_across_computed_windows: 0.1887
